...
public class SBGNLayoutManager
{
    ...
    public Sbgn createLayout(Sbgn sbgn)
    {
        ...
        for(Object lNode: this.layout.getAllNodes())
        {
     ...
     * */
    public void populateCompartmentOccurencesMap(Glyph targetGlyph,  HashMap<String, Integer> compartmentIDandOccurenceMap)
    {
        String rootID = "root";
