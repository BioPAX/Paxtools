...
public class DnaRegionReferenceProxy extends SequenceEntityReferenceProxy<DnaRegionReference> implements DnaRegionReference {
    ...
    public void setSubRegion(DnaRegionReference dnaRegionReference) {
        object.setSubRegion(dnaRegionReference);
    }
